...
router.post("/request/h/accept", requestMiddleware_1.protect, requestUser.acceptUserCase);
router.post("/request/h/reject", requestMiddleware_1.protect, requestUser.rejectUserCase);
